...
def main():
    ...
    # Create a file with a timestamp for the cache and create the output directory
    start_time = datetime.now()
    log_message(f"Starting the timeline at: {start_time}")
    ...
    if target_go_term in mitochondrial_go_terms:
        ...
        # rename the filtered by go file to the filtered by go and mts file for further processing
